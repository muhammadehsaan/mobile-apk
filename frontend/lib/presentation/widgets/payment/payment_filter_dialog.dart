...
class _PaymentFilterDialogState extends State<PaymentFilterDialog>
  ...
  Future<void> _handleApplyFilters() async {
    ...
    if (_selectedPayerType != provider.selectedPayerType) {
      final payerType = _selectedPayerType == _allValue
          ? null
          : _selectedPayerType;
    ...
    if (_selectedPaymentMethod != provider.selectedPaymentMethod) {
      final paymentMethod = _selectedPaymentMethod == _allValue
          ? null
    ...
    if (_paymentMonthFrom != provider.paymentMonthFrom ||
        _paymentMonthTo != provider.paymentMonthTo) {
              ...
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  items: [
                    DropdownItem<String>(
                      value: _allValue,
                      label: l10n.allLabors,
                    ),
                    ...context.read<PaymentProvider>().laborers.map(
              ...
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  items: [
                    ...
                    ...PaymentProvider.staticPayerTypes.map((type) {
              ...
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  items: [
                    DropdownItem<String>(
                      value: _allValue,
                      label: l10n.allMethods,
                    ),
                    ...PaymentProvider.staticPaymentMethods.map(
                      (method) => DropdownItem<String>(
                        value: method,
              ...
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  items: [
                    ...
                    DropdownItem<String>(
                      value: 'false',
                      label: l10n.partialOnly,
                    ),
                  ],
                  value: _isFinalPayment?.toString() ?? _allValue,
                  onChanged: (value) => setState(
                    () => _isFinalPayment = value == _allValue
                        ? null
                        : value == 'true',
                  ),
                ),
            ...
            children: [
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  items: [
                    ...
                    DropdownItem<String>(
                      value: 'true',
                      label: l10n.withReceipt,
                    ),
                    DropdownItem<String>(
                      value: 'false',
                      label: l10n.withoutReceipt,
                    ),
                  ],
                  value: _hasReceipt?.toString() ?? _allValue,
                  onChanged: (value) => setState(
                    () => _hasReceipt = value == _allValue
                        ? null
                        : value == 'true',
                  ),
                ),
              ...
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  onChanged: (value) =>
                      setState(() => _showInactive = value == 'true'),
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                child: _buildDatePicker(
                  ...
                  onDateSelected: (date) =>
                      setState(() => _paymentMonthFrom = date),
                  firstDate: DateTime(2020),
                  lastDate: DateTime.now().add(const Duration(days: 365)),
                ),
              ),
            ...
            children: [
              ...
              Expanded(
                child: PremiumDropdownField<String>(
                  ...
                  onChanged: (value) =>
                      setState(() => _sortAscending = value == 'asc'),
                ),
              ),
            ],
          ),
